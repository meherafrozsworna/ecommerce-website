        ...
        return (
            <div className="container py-5">
                <div className="col-10 mx-auto text-center text-slanted text-blue my-5">
                    <h1 className="text-title text-uppercase text-muted mt-3 mb-2">{product.title}</h1>
                </div>
                <div className="row">
                    ...
                    <div className="col-10 mx-auto col-md-6 my-3 text-capitalize">
                        <h3 ><strong className="text-blue">Model :</strong> {product.title}</h3>  
                        <h4 ><strong className="text-blue">Made by :</strong> {product.company}</h4>
                        <h4 ><strong className="text-blue">Price :</strong> {product.price}</h4>
                        <h4 ><strong className="text-blue">Info :</strong> {product.info}</h4>
                        <h4><strong className="text-blue">InCart :</strong>{product.inCart?<ls> Added to cart</ls>:<l> Not in cart </l>}</h4>
